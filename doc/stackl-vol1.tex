...
\(\textbf{Note:} \)  A separate \\*Volume-2\\* contains the full instruction set reference and a more exhaustive enumeration of opcodes.
...
Base $0x0B00000$ with command byte in the low byte; supported operations:
...
GEN\_IO\_OP\_EXEC     = 5 ; loader via INP\_EXEC\_CALL   \\
\end{tabular}
